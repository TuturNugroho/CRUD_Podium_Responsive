        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"> Dashboard Super <strong><?php echo $user_check; ?></strong></h1>                    <div class="container ">
                        <div class="card flex-fill">
                            <form action="prosesdata.php?aksi=tambah-data" method="post" style="margin: 100px 0 0 200px">
                                <div class="mb-31">


                                    <label for="nama" class="form-label">Name</label>
                                    <input type="nama" class="form-control" id="nama" placeholder="Enter Name" name="user" style="width: 400px" />
                                    <br />
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" placeholder="Enter Email" name="email" style="width: 400px" />
                                    <br />
                                    <label for="Password" class="form-label">Password</label>
                                    <input type="password" class="form-control" id="pass" placeholder="Password" name="pass" style="width: 400px" />
                                    <br />
