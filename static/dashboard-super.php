        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="container ">
                        <button type="button" class="btn btn-secondary" style=" margin-left:700px; margin-bottom:30px"><a style="color: white" class="input" href="tambah-data.php">Tambah Data</a></button>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary"><a class="edit" href="edit-data.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit</a></button>
                                                <button type="button" class="btn btn-danger"><a class="hapus" href="prosesdata.php?id=<?php echo $x['id']; ?>&aksi=hapus">Hapus</a></button>
                                            </td>
                                        </tr>
                                    <?php
                                    }
