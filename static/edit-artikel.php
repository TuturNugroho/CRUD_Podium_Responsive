...
$id = $_GET['id'];
$query = mysqli_query($database->conn, "SELECT * FROM artikel where id = '$id'");
            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="dashboard-admin.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="container ">
                        ...
                        <form action="prosesdata.php?aksi=update-artikel" method="post">
                        <div class="mb-3">
                            <h3>Edit Data</h3>
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <label for="nama" class="form-label">Judul</label>
                            <input type="nama" class="form-control" id="nama" placeholder="Enter Judul" name="judul" value="<?php echo $judul; ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Artikel</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isi" value="<?php echo $isi; ?>"></textarea>
                        </div>
