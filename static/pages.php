        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="container ">
                        <button type="button" class="btn btn-secondary" style=" margin-left:0px; margin-bottom:30px"><a style="color: white" class="input" href="input-artikel.php">Tambah Data</a></button>
                        <div class="card flex-fill">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($database->tampil_artikel() as $x) {
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary"><a class="edit" href="edit-artikel.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit</a></button>

                                                <button type="button" class="btn btn-danger"><a class="hapus" href="prosesdata.php?id=<?php echo $x['id']; ?>&aksi=hapus-artikel">Hapus</a></button>
                                            </td>
                                        </tr>
                                    <?php
                                    }
