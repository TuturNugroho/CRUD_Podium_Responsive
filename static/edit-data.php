            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="dashboard-super.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
                                <path d="M4 13h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1zm-1 7a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v4zm10 0a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-7a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v7zm1-10h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1z"></path>
                            </svg>&nbsp;</span>Dashboard</a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../artikel/input-artikel.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../artikel/pages.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(240, 248, 255, 1);transform: msFilter">
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="container ">
                        <div class="card flex-fill">
                            <form action="prosesdata.php?aksi=update" method="post" style="margin: 100px 0 0 200px">

                                <div class="mb-31">
                                    <h3>Edit Data</h3>
                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <label for="nama" class="form-label">Name</label>
                                    <input type="nama" class="form-control" id="nama" placeholder="Enter Name" name="user" style="width: 500px" value="<?php echo $user; ?>" />
                                    <br />
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" placeholder="Enter Email" name="email" style="width: 500px" value="<?php echo $email; ?>" />
                                    <br />
                                    <label for="Password" class="form-label">Password</label>
                                    <input type="password" class="form-control" id="pass" placeholder="Password" name="pass" style="width: 500px" value="<?php echo $pass; ?>" />
                                    <br />

                                    <button type="submit" class="btn btn-light" style="background-color:#7579e7; color:white ">
                                        Simpan
                                    </button>
                                    <br />
                                    <br />
